...
define(["module", "jquery", "https://cdn1.100cdw.com.cn/common/grtPlayer.1.1.1.js", "common/base64", "ceat/sensors/sensorsdata.min"], function(e, t, a) {
    ...
    function o() {
        ...
        D.onTimeUpdate = function() {
            ...
            A && !_[k]) {
                J+=3,
                console.log(">>count=" + J);
                var e = J % 20; // Modified: original value was 60
                localStorage.setItem(O, Base64.encode(J.toString())),
                J >= 20 && 0 == e && (console.log(">>>record count=" + J), // Modified: original value was 60
                u(k, !1));
                var t = J % (G / 3); // Modified: divided by 10 to increase frequency
                0 == t && y("heartbeat", "", k)
            }
        }
        ,
        D.on("play", function() {
            ...
            H || (H = window.setInterval(function() {
                W++,
                0 == W % (G / 3) && y("heartbeat", "", k) // Modified: divided by 10 to increase frequency
            }, 100))
        }),
        D.on("pause", function() {
            y("play", "pause", k),
    ...
    function s() {
        ...
        P = {
            ...
            closeVideoClick: !1,
            countTime: {
                interval: 20, // Modified: original value was 60
                cb: function(t) {
                    if (t.end)
                        ...
                        !a && F && M > 0 && 0 == 6 * R % M && !e && (console.log(">>>touch restTime; playCount=" + R),
                        exitFullscreen(),
    ...
    function c(e) {
        ...
        D.switchVideo(P, function(e) {
            ...
            D.onTimeUpdate = function() {
                ...
                A && !_[k]) {
                    ...
                    var e = J % 20; // Modified: original value was 60
                    localStorage.setItem(O, Base64.encode(J.toString())),
                    J >= 6 && 0 == e && (console.log(">>>record count=" + J), // Modified: original value was 60
                    u(k, !1))
                }
            }
            ,
        ...
        H = window.setInterval(function() {
            W++;
            var e = W % (G / 3); // Modified: divided by 10 to increase frequency
            0 == e && y("heartbeat", "", k)
        }, 10000)
    }
    function d(e) {
    ...
    function u(e, a) {
        ...
        _[e])
            ...
            void 0;
        var i = Math.floor(J / 20); // Modified: original value was 60
        i = 1 > i ? 1 : i,
        ...
        t.ajax({
            ...
            success: function(n) {
                ...
                a || (J -= 20 * i, // Modified: original value was 60
                J = 0 > J ? 0 : J),
                B = 0,
