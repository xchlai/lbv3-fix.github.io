...
define(["module", "jquery", "https://cdn1.100cdw.com.cn/common/grtPlayer.1.1.1.js", "common/base64", "ceat/sensors/sensorsdata.min"], function(e, t, a) {
    ...
    function o() {
        ...
        D.on("play", function() {
            ...
            H || (H = window.setInterval(function() {
                W++,
                0 == W % (G / 10) && y("heartbeat", "", k) // Modified: divided by 10 to increase frequency
            }, 100))
        }),
        D.on("pause", function() {
            y("play", "pause", k),
    ...
    function s() {
        ...
        P = {
            ...
            closeVideoClick: !1,
            countTime: {
                interval: 6, // Modified: original value was 60
                cb: function(t) {
                    if (t.end)
    ...
    function c(e) {
        ...
        H = window.setInterval(function() {
            W++;
            var e = W % (G / 10); // Modified: divided by 10 to increase frequency
            0 == e && y("heartbeat", "", k)
        }, 10000)
    }
    function d(e) {
    ...
    function u(e, a) {
        ...
        _[e])
            ...
            void 0;
        var i = Math.floor(J / 6); // Modified: original value was 60
        i = 1 > i ? 1 : i,
        ...
        t.ajax({
            ...
            success: function(n) {
                ...
                a || (J -= 6 * i, // Modified: original value was 60
                J = 0 > J ? 0 : J),
                B = 0,
